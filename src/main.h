...
public:
    ...
    {
        // Smecoins: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Smecoins: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Smecoins: two types of block: proof-of-work or proof-of-stake
    ...
    // Smecoins: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Smecoins: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Smecoins: block index flags
    enum  
    {
