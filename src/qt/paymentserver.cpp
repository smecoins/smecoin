...
const QString BITCOIN_IPC_PREFIX("Smecoins:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Smecoins: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Smecoins: click-to-pay handler");
    else
...
{
    // clicking on Smecoins: URLs creates FileOpen events on the Mac:
